...
public class MainActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener{
    ...
    private static final String URL = "https://ximenacbtis72.000webhostapp.com/json/contacts.php";
    ...
    private void fetchContact() {
        JsonArrayRequest request = new JsonArrayRequest(URL, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                if (response == null) {
                    Toast.makeText(getApplicationContext(), "FALLO HIJO", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void onContactSelected(Contact contact) {
        Toast.makeText(getApplicationContext(), "Selecciono a " + contact.getName() + ", su número de telefono es:" + contact.getPhone(), Toast.LENGTH_SHORT).show();
    }
}
